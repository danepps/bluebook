...
> **Style last updated: May 27, 2026.** If you installed this style previously, see [Updating](#updating) below to get the latest version.
...
> **Handled by the plug-in (beta).** Three of these gaps — `[hereinafter …]`, volume-is-a-year, and title-ends-in-a-numeral — are fixed by Prof. Epps's companion citations-fixer plug-in, **[danepps/zotero](https://github.com/danepps/zotero)**, which can introspect the data and post-process citation output in ways a pure CSL file cannot. The plug-in is **still in beta**: install it alongside this style if you want those fixes, and expect some rough edges.
